...
<head>
    ...
    <style>
        ...
        body{
            background: linear-gradient(to left, #6754c7, #2471a3);
        }
     ...
     <!-- End of right side first block -->
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="well well-sm"> Say goobye to login <a href="http://localhost/OAuth/login.php" target="_self">Save Cookies </a> Now </div>
...
window.onbeforeunload = function() {
  var dialogText = 'Malinda Chamal Presents';
  alert(dialogText);
};
